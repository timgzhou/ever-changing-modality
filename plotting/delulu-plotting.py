...
plt.tight_layout()
plt.savefig("artifacts/delulu-plotting_combined.png", bbox_inches='tight', dpi=150)
print("Saved to artifacts/delulu-plotting_combined.png")

# python plotting/delulu-plotting.py
