"""
Qualitative DeluluNet predictions vs teacher and oracle, per Delulu scenario.
...
predict_from_real_modalities (mirroring evaluate_multimodal in delulu.py):
...
Usage:
    python viz/viz_dfc2020_delulu_preds.py \
...
from dfc2020_data_utils import (                              # noqa: E402
    COBENCH_CLASS_NAMES, COBENCH_NUM_CLASSES, DFC2020_IGNORE_INDEX)
