...
#
# Usage:
#   sbatch --array=0-17 sh/train_delulu_biomassters_best_job.sh              # s1 -> s2
#   DIRECTION=s2s1 sbatch --array=0-17 sh/train_delulu_biomassters_best_job.sh
#
...
mkdir -p logs/train_delulu_best checkpoints res/delulu
